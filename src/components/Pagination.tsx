const Pagination = () => {
  return (
    <div className='p-4 flex items-center justify-center  md:justify-between text-gray-500'>
        ...
        <div className='flex items-center gap-2 text-base'>
            <button className="px-1 md:px-2 rounded-sm bg-sky">1</button>
            <button className="px-1 md:px-2 rounded-sm">2</button>
            <button className="px-1 md:px-2 rounded-sm">3</button>
            ...
